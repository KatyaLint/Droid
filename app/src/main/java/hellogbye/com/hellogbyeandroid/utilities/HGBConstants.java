 ...
 */
public class HGBConstants {

    public static int PROFILE_IMAGE_WIDTH =150;
    public static int PROFILE_IMAGE_HEIGHT =150;
    public static final String ARG_NAV_NUMBER = "nav_number";
    public static final String HOME_FRAGMENT_TOOLBAR_ACTION = "toolbar_action";
    ...
    public static final String BUNDLE_ADD_COMPANION_CNC = "add_companion_cnc";
 ...
 //   public static final String BUNDLE_IS_POST_BOOKING_EXIST = "bundle_is_post_booking_exist";
    ...
    public static final String SHARED_PREFS = "hgb_prefs";
    ...
    public static final String HGB_USER_SIGNALR_CONNECTION_LOGIN_ID = "user_signalr_connection_login_id";

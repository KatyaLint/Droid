...
//        mAdapter = new AlternativeHotelAdapter.ViewHolder(mArrayNodes);
...
//                    .inflate(R.layout.alternate_flight_item, parent, false);
//
...
//            holder.mHotelName.setText(mArrayList.get(position).getmHotelName());
//            holder.mHotelPrice.setText(String.valueOf((int)mArrayList.get(position).getmMinimumAmount()));
//            holder.mHotelNights.setText(mArrayList.get(position).getmCheckIn());
//            setStarRating(holder,mArrayList.get(position).getmStarRating());
//
//        }
//

...
public class ItineraryFragmentAdapter extends HGBAbstractFragment implements TitleNameChange {
    ...
    public static Fragment newInstance(int position) {
        Fragment fragment = new ItineraryFragmentAdapter();
    ...
    private void createPassengersName(View scrollViewLinearLayout, UserTravelMainVO user){
        ...
        new_grid_add_companion_ll.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                args.putString("class_name", ItineraryFragmentAdapter.class.toString());
            ...
            /*    ArrayList<NodesVO> passengerNodes = passengers.get(i).getPassengerNodes();
               ...
               /* if(i%2 == 0) {
                ...
                for (NodesVO node : passengerNode) {
                    ...
                    //    NodeLinearLayout.addView(view);
                    } else if (NodeTypeEnum.FLIGHT.getType().equals(node.getmType())) {
                        System.out.println("Kate current flight");
                        //create flight
                        getAlternativeFlights(node, NodeLinearLayout);
                       // view = getAlternativeFlights(node, view);
                      ...
                      //  view.setTag(NodeTypeEnum.FLIGHT.getType());
                        ...
                        counter = 0;
                        System.out.println("Kate current hotel");
                        getAlternativeHotel(node);
   ...
   private View.OnClickListener nodeClickListener = new View.OnClickListener() {
            ...
            //                NodeTypeEnum.FLIGHT.getType();
                if (NodeTypeEnum.FLIGHT.getType().equals(nodeType)){
                  ...
                  //  Fragment fragment = new AlternativeFlightFragment();
                    ...
                    System.out.println("Kate guidSelectedUser ="  + guidSelectedUser);
    ...
    View viewTemp;
    private void getAlternativeFlights(NodesVO currentNodeVO, final LinearLayout nodeLinearLayout) {

        String solutionID = getActivityInterface().getTravelOrder().getmSolutionID();

        String paxId = currentNodeVO.getmPaxguid(); //getSelectedUserGuid();
        ...
        ItineraryHelper.getAlternativeFlights(paxId, flightID, getActivityInterface(), getActivity(), new IntItineraryHelper() {
            ...
            public void finished() {
                List<NodesVO> alternatives = getActivityInterface().getAlternativeFlights();
                System.out.println("Kate alternatives!! ="  +alternatives.size());
              //  View view =  new View(getContext());
                for (NodesVO node: alternatives){
                    View view = flightLayout(node,0);
                    view.setTag(NodeTypeEnum.FLIGHT.getType());
                    view.setOnClickListener(nodeClickListener);
                    view.setPadding(
                            (int) getResources().getDimension(R.dimen.DP6),
            ...
            public void errorReceived(Object data) {
                System.out.println("Kate error data = ");
                ErrorMessage(data);
            }
        });
    ...
    private void getAlternativeHotel(NodesVO currentNodeVO) {
        ...
        //TODO change ispromoAlternative
        ItineraryHelper.getAlternativeHotel( paxId ,flightID, currentNodeVO.getmCheckIn(), currentNodeVO.getmCheckOut(), false, getActivityInterface(), getActivity(), new IntItineraryHelper(){


            @Override
            public void finished() {
                List<NodesVO> alternatives = getActivityInterface().getAlternativeHotels();
                System.out.println("Kate hotels!! ="  +alternatives.size());
            }
    ...
    private View flightLayout(NodesVO node, int counter){
      ...
      //  grid_flight_square_ll.setText(node.getmOriginCityName() + " - " + node.getmDestinationCityName());
...
*/
   ...
   /*     TextView grid_flight_operator_arrival = (TextView)child.findViewById(R.id.grid_flight_operator_arrival);
        grid_flight_operator_arrival.setText("Arrival: "+HGBUtilityDate.parseDateToHHmm(node.getmArrival()));*/
...
/*        ImageView hotel_bad_image = (ImageView)child.findViewById(R.id.hotel_bad_image);
   ...
   private LayoutParams layoutParams = new LayoutParams(
    ...
    private void createItinenaryView(View view){
     ...
     /*   ViewPager viewPager = (ViewPager)scrollViewLinearLayout.findViewById(R.id.viewpager);
        viewPager.setAdapter(new ItineraryPagerAdapter(getContext()));*/

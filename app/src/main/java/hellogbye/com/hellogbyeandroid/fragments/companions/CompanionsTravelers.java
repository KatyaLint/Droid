 ...
 */
public class CompanionsTravelers extends CompanionsTabsViewClass implements SearchView.OnQueryTextListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
     ...
     //   View rootView = inflater.inflate(R.layout.companions_travel, container, false);
